...
const module_name = "xdg_desktop_entry";
...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here module_name is the name you will use in your source code to
                // import this module (e.g. `@import(module_name)`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = module_name, .module = mod },
            },
        }),
    });
    ...
    const cli_step = b.step("cli", "Run the CLI application");
